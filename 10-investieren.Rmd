...
- The S&P 500 is a "weighted index" (the weights depend on the companies' market-capitalisation), which puts more weight on "winners" ([Youtube-Video von Marc Tillbury, März 2026](https://youtu.be/O8t50OxsfB8?si=OWC1ke2vlqIhQoiq)).
- An alternative to the (US based) S&P500, would be to have a "Global (marketcap weighted) index": this way, you avoid being dependent on the US-economy alone (it is risky to solely bet on US-companies; [Youtube-Video von Marc Tillbury, März 2026](https://youtu.be/O8t50OxsfB8?si=OWC1ke2vlqIhQoiq)).

### Rohstoffe

- Gold is implemented in the "Basel 3" act and China is currently (2026) investing massively into gold, which will weaken the dollar-dominance in the long-run ([Youtube-Video von Marc Tillbury, März 2026](https://youtu.be/O8t50OxsfB8?si=OWC1ke2vlqIhQoiq)).
