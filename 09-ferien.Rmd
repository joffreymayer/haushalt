...
## Learnings & Heuristiken aus vergangenen Ferien
...
<ins>Ferien an Seen</ins>: Vorsicht vor **Blaualgen**, denn diese können beim **Schlucken von Seewasser tödlich** sein für **Babys**.
...
## Events & Aktivitäten | Beispiele für die Freizeit
...
- Gemäss [dieser Seite](https://www.cgn.ch/de/) gibt es **zwei Arten von Rundfahrten (ab Genf)**:
